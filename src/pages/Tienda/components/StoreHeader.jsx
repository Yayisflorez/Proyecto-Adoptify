...
import {
  Search, Bell, Sun, Moon, ChevronDown, LogOut, Settings, Store, MessageSquare, Package, ShoppingCart, Star,
} from "lucide-react";
...
export default function StoreHeader({ storeNombre, onLogout }) {
  ...
  const notificacionesNoLeidas = mockStoreNotifications.filter((n) => !n.leida).length;
  ...
  const getTipoIcon = (tipo) => {
    switch (tipo) {
      ...
      case "sistema": return MessageSquare;
  ...
  const getTipoColor = (tipo) => {
    switch (tipo) {
      ...
      case "producto": return "bg-amber-50 text-amber-600 dark:bg-amber-500/10 dark:text-amber-400";
      case "valoracion": return "bg-yellow-50 text-yellow-600 dark:bg-yellow-500/10 dark:text-yellow-400";
      case "admin": return "bg-purple-50 text-purple-600 dark:bg-purple-500/10 dark:text-purple-400";
      case "sistema": return "bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400";
            ...
            {notificacionesOpen && (
              <div className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white dark:bg-dark-card rounded-2xl shadow-xl border border-gray-100 dark:border-dark-border animate-scale-in overflow-hidden">
                ...
                <div className="max-h-80 overflow-y-auto scrollbar-hide">
                  {mockStoreNotifications.slice(0, 5).map((notif) => {
                ...
                <div className="p-2 border-t border-gray-100 dark:border-dark-border">
                  <button
                    onClick={() => { navigate("/tienda/notificaciones"); setNotificacionesOpen(false); }}
          ...
          <div className="relative" ref={perfilRef}>
            ...
            {perfilOpen && (
              <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-dark-card rounded-2xl shadow-xl border border-gray-100 dark:border-dark-border animate-scale-in overflow-hidden">
                ...
                <div className="p-1">
                  <button
                    onClick={() => { navigate("/tienda/configuracion"); setPerfilOpen(false); }}
